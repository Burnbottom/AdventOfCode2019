...
def opCodeOperator(data, firstPosUpdate=None, secondPosUpdate=None, input=None):
    datatmp = [int(d) for d in data.split(",")]
    output = []
    inputData = datatmp.copy()
...
def main():
    ...
    inputData3 = "3,9,7,9,10,9,4,9,99,-1,8"
    inputData4 = "3,3,1108,-1,8,3,4,3,99"
    inputData5 = "3,3,1107,-1,8,3,4,3,99"
    ...
    print(f"answer part 1: {opCodeOperator(data=inputData, input=1)}")

    print(f"answer part 1: {opCodeOperator(data=inputData2, input=8)}")

    print(f"answer part 1: {opCodeOperator(data=inputData3, input=7)}")

    print(f"answer test 4: {opCodeOperator(data=inputData4, input=7)}")

    print(f"answer part 1: {opCodeOperator(data=inputData5, input=8)}")

    print(f"answer part 1: {opCodeOperator(data=inputData6, input=1)}")

    print(f"answer part 1: {opCodeOperator(data=inputData7, input=1)}")

    print(f"answer part 1: {opCodeOperator(data=inputData8, input=7)}")
    print(f"answer part 1: {opCodeOperator(data=inputData8, input=8)}")
    print(f"answer part 1: {opCodeOperator(data=inputData8, input=9)}")
    print(f"answer part 2: {opCodeOperator(data=inputData, input=5)}")
