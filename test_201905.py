...
class TestMethods(unittest.TestCase):
    def test1(self):
        ...
        self.assertEqual(5182797, getLastVal(answer))
    ...
    def test2(self):
        ...
        self.assertEqual(1, getLastVal(answer))
    ...
    def test3(self):
        ...
        self.assertEqual(0, getLastVal(answer))
    ...
    def test8(self):
        ...
        self.assertEqual(999, getLastVal(answer))

        answer = opCodeOperator(data=inputData8, input1=8)
        self.assertEqual(1000, getLastVal(answer))

        answer = opCodeOperator(data=inputData8, input1=9)
        self.assertEqual(1001, getLastVal(answer))
